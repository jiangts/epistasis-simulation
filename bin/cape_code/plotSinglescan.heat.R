...
#as a heatmap
#The values can be thresholded and scaled. Use
#scale.fun to scale. scale.fun can be something
#like "sqrt" or "log10" etc.



plotSinglescan.heat <- function(data.obj, standardized = TRUE, show.marker.labels = FALSE, show.chr.boundaries = TRUE, label.chr = TRUE, threshold.above = NULL, color = "lightblue2", scale.fun = NULL){
