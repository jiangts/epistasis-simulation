#This script takes the beta prime matrix calculated in
#direct.influence.R and calculates the average influence
#of each marker on each phenotype

direct.influence <- function(data.obj, transform.to.phenospace = TRUE, pval.correction = c("holm", "fdr", "lfdr"), verbose = FALSE, save.permutations = FALSE) {
