#This function removes individuals from both the
#phenotype and genotype matrices if the individuals
#have missing phenotype data. This is an internal
#function

remove.ind.with.missing.pheno <- function(data.obj){
