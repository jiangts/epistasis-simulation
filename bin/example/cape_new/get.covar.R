#Given the data object with the oneD scan results,
#and covariate thresholds, this script generates 
#covariate flags for each marker. 


get.covar <- function(data.obj, covar.thresh = NULL){
