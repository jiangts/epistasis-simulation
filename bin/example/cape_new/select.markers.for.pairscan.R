...
#if num.markers is specified, this supercedes 
#use.pairs.threshold and a threshold is set such
#that the given number of markers (within the 
#tolerance specifiec) are selected.

select.markers.for.pairscan <- function(data.obj, use.pairs.threshold = FALSE, pairscan.thresh = NULL, specific.markers = NULL, num.markers = NULL, start.thresh = 4, tolerance = 10, verbose = TRUE){
